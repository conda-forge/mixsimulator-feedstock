...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mixsimulator-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11416&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mixsimulator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mixsimulator` can be installed with:

```
conda install mixsimulator
```

It is possible to list all of the versions of `mixsimulator` available on your platform with:
